...
if(isset($_GET['id'])){
    ...
    $result = $conn->query("SELECT * FROM doctor WHERE did='$did'");

    $items=$result->fetch_array();
    $did=$items['did'];
    $dname=$items['dname'];
    $dcontact=$items['dcontact'];
    $hname=$items['hname'];
    $pid=$items['pid'];
}
        ...
        <form id='patient'  method="POST" class="form">
            <div class="row">
                ...
                <div class="column">
                    ...
                    <input type="text" name="dname" value="<?php echo $dname; ?>" placeholder="Doctor Name"> 
                </div>
            </div>
            <div class="row">
                <div class="column">
                    <label>Contact</label>
                    <input type="text" name="dcontact" value="<?php echo $dcontact; ?>" placeholder="Doctor Contact"> 
                </div>
                <div class="column">
            ...
            <div class="column">
                    ...
                    <input type="text" name="pid"  value="<?php echo $pid; ?>" placeholder="Patient ID">
                </div>
            </div>
