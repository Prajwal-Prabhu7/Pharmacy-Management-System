    ...
    <div class="container">
        <div class="row">
            ...
            <?php
                              ...
                              echo '<span style="color:#DC143C;">TOTAL DOCTORS:</span>';
                              ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['Count'];
...
$conn=mysqli_connect("localhost","root","","pharmacyms");
    ...
    if(mysqli_num_rows($query_run)>0)
    {
        foreach($query_run as $items)
        {
            ...
            <td><?php echo $items['dcontact'];?></td>
            <td><?php echo $items['hname'];?></td>
            <td><?php echo $items['pid'];?></td>
            <td><a href="doctor_update.php?id=<?php echo $items['did']; ?>" data-toggle="
            tooltip" data-placement="bottom" title="EDIT"> <i class="fa fa-trash" aria-hidden="true">EDIT</i> </a> </td>
            <td><a href="doctor_delete.php?id=<?php echo $items['did']; ?>" data-toggle="
